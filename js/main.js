var parent = document.querySelectorAll(".has-saka");
...
node.forEach(function (element) {
  element.addEventListener(
    "mouseover",
    function () {
      element.querySelector(".saka").classList.add("active");
    },
    false
  );
  element.addEventListener(
    "mouseout",
    function () {
      element.querySelector(".saka").classList.remove("active");
    },
    false
  );
});
...
var endDate = new Date('2022/08/29 00:00:00');
var interval = 1000;
